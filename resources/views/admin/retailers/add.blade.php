    ...
    <table bgcolor="#F9F9F9" width="100%" cellpadding="2" cellspacing="3"  border="0" align="center">
        ...
        <tr>
            ...
            <td width="70%" valign="top"><input type="text" name="title" id="rname" value="" size="62" class="textbox" />
                @if($errors->first('title')) <small class="error">{{$errors->first('title')}}</small> @endif
            </td>
        </tr>
        <tr>
            ...
            <td width = '70%' valign = 'top'><input type="text" name = 'slug' id = 'slug' value = '' class = 'textbox' />
                @if($errors->first('slug')) <small class="error">{{$errors->first('slug')}}</small> @endif
            </td>
        </tr>
        <tr>
                ...
                <div class="scrollbox">
                    @if($categories)
                        ...
                        @foreach($categories as $category)
                            ...
                            ?>
                            <div class = {{$class}}>
                                <input name = 'category_id[]' value="{{$category->category_id}}" type ='checkbox'>{{$category->name}}
                            </div>
                        @endforeach
                     @endif
                ...
                <div class="scrollbox">
                    ...
                    @if($countries)
                        ...
                        @foreach($countries as $country)
                            ...
                            ?>
                            <div class = {{$class}}>
                                <input name = 'country_id[]' value="{{$country->country_id}}" type ='checkbox'>{{$country->name}}
                            </div>
                        @endforeach
                    @endif
        ...
        <tr>
            ...
            <td nowrap="nowrap" width="70%" valign="top">
                ...
                @if($errors->first('url')) <small class="error">{{$errors->first('url')}}</small>@endif
            </td>
        </tr>
        <tr>
